            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h6 class="font-weight-bold m-0">Billing Submissions</h6><a class="btn btn-outline-dark btn-sm" role="button" href="manage-billing.php">GO TO LIST OF BILLINGS</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-center">
                                                            <div class="btn-group btn-group-sm" role="group"><button class="btn btn-outline-info btn-sm" data-toggle="modal" data-bss-tooltip="" type="button" data-target="#modal_form_2" title="View Form 2 Scanned Copy"><i class="far fa-file-alt"></i></button><a class="btn btn-outline-info btn-sm" role="button" data-toggle="tooltip" data-bss-tooltip="" title="View Form 2 List" href="manage-billing-hei-submission-form2.php"><i class="fas fa-list"></i></a></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group btn-group-sm" role="group"><button class="btn btn-outline-info btn-sm" data-toggle="modal" data-bss-tooltip="" type="button" data-target="#modal_form_2" title="View Form 3 Scanned Copy"><i class="far fa-file-alt"></i></button><a class="btn btn-outline-info btn-sm" role="button" data-toggle="tooltip" data-bss-tooltip="" title="View Form 3 List" href="manage-billing-hei-submission-form3.php"><i class="fas fa-list"></i></a></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
