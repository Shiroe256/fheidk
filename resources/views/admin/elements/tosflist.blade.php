        ...
        @foreach ($fees as $fee)
            <tr>
                ...
                <td class="text-center">
                    <button id="{{ $fee->uid }}" class="btn_update_fee btn_edit btn btn-primary" type="button" data-toggle="modal" data-target="#modal_update_tosf" title="Edit Fee"><i class="fas fa-pen"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
