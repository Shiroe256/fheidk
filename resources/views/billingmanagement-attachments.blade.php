    ...
    <div class="card shadow">
        <div class="mx-auto mt-3 alert alert-info" style="">
            ...
            <h2>Billing Status: 
                ...
                @elseif ($billings->billing_status == 3)
                    <span class="">Done Validating</span>
                @elseif ($billings->billing_status == 4)
                ...
                @elseif ($billings->billing_status == 7)
                    <span class="">For revision</span>
                @elseif ($billings->billing_status == 8)
                    <span class="">Submitted to CHED-AFMS</span>
                @elseif ($billings->billing_status == 9)
                    <span class="">Ready for Disbursement</span>
                @elseif ($billings->billing_status == 10)
