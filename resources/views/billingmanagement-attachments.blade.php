                                    ...
                                    <div class="col-lg-3 col-xl-12 d-flex justify-content-between">
                                        ...
                                        <div class="dropdown no-arrow">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right animated--fade-in">
                                              ...
                                              <a class="dropdown-item" href="{{ Request::url() . '/form1' }}" target='_blank'><i class="fas fa-file-download fa-sm fa-fw mr-2 text-gray-400"></i> Form 1 (Billing Summary)</a>
                                              <a class="dropdown-item" href="{{ Request::url() . '/form2' }}" target='_blank'><i class="fas fa-file-download fa-sm fa-fw mr-2 text-gray-400"></i> Form 2 (Billing Details)</a>
                                              <a class="dropdown-item" href="{{ Request::url() . '/form3' }}" target='_blank'><i class="fas fa-file-download fa-sm fa-fw mr-2 text-gray-400"></i> Form 3 (Billing Details)</a>
                                            </div>
                                          </div>
