    ...
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between align-items-center"><a
            ...
            <div class="btn-group" role="group">
                ...
                <button class="btn btn-outline-info btn-sm" type="button" data-toggle="modal"
                    data-target="#mod_upload"><i class="fas fa-file-upload"></i>&nbsp;Upload List</button>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col text-right">
                                        <div class="btn-group" role="group"><button
                                                ...
                                                type="button"><i class="fas fa-user-minus"></i>&nbsp;Remove</button>
                                        </div>
                                    </div>
                                </div>
