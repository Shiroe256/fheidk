    ...
    <div class="card shadow">
        <div class="mx-auto mt-3 alert alert-info" style="">
            ...
            <h4>Instructions: 
                ...
                <b>Note(s):</b>
                <ul>
                    <li style="font-size:15px;"><i>The UniFAST Billing Unit will review your submission.</i></li>
                    <li style="font-size:15px;"><i>You can view the status and content of the submitted billing, but you will not be able to edit its content.</i></li>
                </ul>                
                @elseif ($billing_status == 7)
                <ol>
            ...
            @if ($billing_status != 2 || $billing_status >= 5)
                <div class="btn-group" role="group">
                    ...
                    <button id="btn_finalize" class="btn btn-outline-primary btn-sm" type="button"
                        value="{{ $reference_no }}" {{$billing_status == 3 ? "" : "hidden"}}><i class="far fa-file-alt"></i>&nbsp;Finalize</button>
                </div>
            @endif
        </div>
