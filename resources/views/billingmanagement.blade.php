...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="mx-auto alert alert-info" style="">
            <h2>Billing Status: 
                @if ($billing_status == 1)
            ...
            <h4>Instrunctions: 
                @if ($billing_status == 1)
                <ol>
                    <li class="" style="font-size:13px;">Download billing template</li>
                    <li class="" style="font-size:13px;">Upload the filled out billing template</li>
                    <li class="" style="font-size:13px;">Click the <b>Run validation</b> button</li>
                </ol>
                @elseif ($billing_status == 2)
                <ul>
                    <li class="" style="font-size:13px;">Refresh the page to check if the validation is done</li>
                </ul>
                @elseif ($billing_status == 3)
                <ul>
                    <li class="" style="font-size:13px;">The billing is ready for submission. However, the HEI can still add, edit or remove student in the billing</li>
                </ul>
                @elseif ($billing_status == 4)
                <ol>
                    <li class="" style="font-size:13px;">Refer to the exceptions generated by the system, remove the duplicate entries and student who exceeded the program's Maximum Residency Rule (MRR)</li>
                    <li class="" style="font-size:13px;">After removing, click the <b>Run validation</b> button </li>
                </ol>
                @elseif ($billing_status == 5)
                <ol>
                    <li class="" style="font-size:13px;">Download, print and sign the Billing Form 1, 2 and 3</li>
                    <li class="" style="font-size:13px;">Upload the signed forms and other attachments to your google drive</li>
                    <li class="" style="font-size:13px;">Attach the links from the google drive</li>
                    <li class="" style="font-size:13px;">Click <b>"Submit for Review"</b> button</li>
                </ol>
                @elseif ($billing_status == 6)
                <b>Note(s):</b>
                <ul>
                    <li class="" style="font-size:13px;"><i>UniFAST Billing Unit will review your submission</i></li>
                    <li class="" style="font-size:13px;"><i>You can view the status and content of the submitted billing but, you will not be able to edit its content</i></li>
                </ul>
                @elseif ($billing_status == 7)
                <ol>
                    <li class="" style="font-size:13px;">Refer to the remarks and apply necessary changes to the billing</li>
                    <li class="" style="font-size:13px;">Click the <b>"Run Validation"</b> button</li>
                </ol>
                @elseif ($billing_status == 8)
                <b>Note(s):</b>
                <ul>
                    <li class="" style="font-size:13px;"><i>CHED AFMS Unit will review your submission</i></li>
                    <li class="" style="font-size:13px;"><i>You can view the status and content of the submitted billing but, you will not be able to edit its content</i></li>
                </ul>
                @elseif ($billing_status == 9)
                <b>Note(s):</b>
                <ul>
                    <li class="" style="font-size:13px;"><i>CHED AFMS will process the billing for disbursement</i></li>
                    <li class="" style="font-size:13px;"><i>You can view the status and content of the submitted billing but, you will not be able to edit its content</i></li>
                </ul>
                @elseif ($billing_status == 10)
                <b>Note(s):</b>
                <ul>
                    <li class="" style="font-size:13px;"><i>Disbursed</i></li>
                    <li class="" style="font-size:13px;"><i>You can view the status and content of the submitted billing but, you will not be able to edit its content</i></li>
                    <li class="" style="font-size:13px;"><i>End of Billing Process</i></li>
                </ul>
                @endif
            </h4>
        </div>
