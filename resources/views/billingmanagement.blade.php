        ...
        <div id="billing_forms_div"
            ...
            <div>
                <ul class="nav nav-pills nav-fill nav-justified" role="tablist">
                    <li class="nav-item"><a class="nav-link active input-style-tabs" style="border-top: 2px solid #d3d3d3;border-left: 2px solid #d3d3d3;border-right: 2px solid #d3d3d3;border-bottom: none;" role="tab" data-toggle="tab"
                            href="#tab-4">Billing Form 1</a></li>
                    <li class="nav-item"><a class="nav-link input-style-tabs" style="border-top: 2px solid #d3d3d3;border-left: 2px solid #d3d3d3;border-right: 2px solid #d3d3d3;border-bottom: none;" role="tab" data-toggle="tab"
