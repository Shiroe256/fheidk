        ...
        <div id="billing_forms_div"
            ...
            <div>
                <ul class="nav nav-pills nav-fill nav-justified" role="tablist">
                    <li class="nav-item"><a class="nav-link active input-style-tabs" style="border-color:rgb(187, 187, 187); border-style:solid;border-width: 3px;border-botom:0;" role="tab" data-toggle="tab"
                            href="#tab-4">Billing Form 1</a></li>
                    <li class="nav-item"><a class="nav-link input-style-tabs" style="border-color:rgb(187, 187, 187); border-style:solid;border-width: 3px;border-botom:0;" role="tab" data-toggle="tab"
