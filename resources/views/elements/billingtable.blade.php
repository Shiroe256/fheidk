                ...
                @foreach ($billings as $id => $billing)
                    <tr>
                        ...
                        <td class="text-center">
                            <?php
                            if($billing->billing_status==1):?>
                            <span class="badge badge-pill badge-secondary span-size"><p>Download billing template</p> <p>Upload the filled out billing template</p> <p>Click the <b>Run validation</b> button</p></span>
                            <?php
                            elseif ($billing->billing_status==2):?>
                            <span class="badge badge-pill badge-info span-size"><p>Refresh the page to check if the validation is done</p></span>
                            <?php
                            elseif ($billing->billing_status==3):?>
                            <span class="badge badge-pill badge-primary span-size"><p>The billing is ready for submission. However, the HEI can still add, edit or remove student in the billing</p></span>
                            <?php
                            elseif ($billing->billing_status==4):?>
                            <span class="badge badge-pill badge-danger span-size"><p>Refer to the exceptions generated by the system, remove the duplicate entries and student who exceeded the program's Maximum Residency Rule (MRR)</p><p>After removing, click the <b>Run validation</b> button </p></span>
                            <?php
                            elseif ($billing->billing_status==5):?>
                            <span class="badge badge-pill badge-primary span-size"><p>Download, print and sign the Billing Form 1, 2 and 3</p> <p>Upload the signed forms and other attachments to your google drive</p><p>Attach the links from the google drive</p><p>Click <b>"Submit for Review"</b> button</p></span>
                            <?php
                            elseif ($billing->billing_status==6):?>
                            <span class="badge badge-pill badge-primary span-size"><p>UniFAST Billing Unit will review your submission</p><p>You can view the status and content of the submitted billing but, you will not be able to edit its content</p></span>
                            <?php
                            elseif ($billing->billing_status==7):?>
                            <span class="badge badge-pill badge-danger span-size"><p>Refer to the remarks and apply necessary changes to the billing</p><p>Click the <b>"Run Validation"</b> button</p></span>
                            <?php
                            elseif ($billing->billing_status==8):?>
                            <span class="badge badge-pill badge-warning span-size"><p>CHED AFMS Unit will review your submission</p><p>You can view the status and content of the submitted billing but, you will not be able to edit its content</p></span>
                            <?php
                            elseif ($billing->billing_status==9):?>
                            <span class="badge badge-pill badge-success span-size"><p>CHED AFMS will process the billing for disbursement</p><p>You can view the status and content of the submitted billing but, you will not be able to edit its content</p></span>
                            <?php
                            elseif ($billing->billing_status==10):?>
                            <span class="badge badge-pill badge-success span-size"><p>Disbursed</p><p>You can view the status and content of the submitted billing but, you will not be able to edit its content</p></span>
                            <?php
                            endif;?>
                        </td>
                        <td class="text-center">
