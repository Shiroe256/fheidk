                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php elseif ($billing->billing_status === 5): ?>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a class="btn btn-outline-primary" role="button" data-toggle="tooltip" data-bs-tooltip="" data-placement="bottom" title="Attachments" href="{{ route('billings') . '/' . $billing->reference_no }}"><i class="far fa-eye"></i></a>
                                </div>
                            <?php else: ?>
                                <div class="btn-group btn-group-sm" role="group">
