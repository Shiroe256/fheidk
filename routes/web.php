...
Route::get('/billings/{reference_no?}/attachments', [BillingController::class, 'billingmanagementpage_Jojo'])->name('billingmanagementpage_Jojo')->middleware('checkUserHei');
