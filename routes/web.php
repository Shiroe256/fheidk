...
Route::get('/billings/{reference_no?}/attachments', [BillingController::class, 'billingmanagementattachmentsJojo'])->name('billingmanagementattachmentsJojo')->middleware('checkUserHei');
