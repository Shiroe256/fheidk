...
Route::get('/billings/{reference_no?}/attachments', [BillingController::class, 'billingmanagementattachments_Jojo'])->name('billingmanagementattachments_Jojo')->middleware('checkUserHei');
