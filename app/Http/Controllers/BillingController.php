                    ...
                    $join->on('tbl_other_school_fees.course_enrolled', '=', 'students_sub.degree_program')
                        ...
                        ->where(function ($query) {
                            $query->where(function ($query) {
                                $query->where('students_sub.transferee', 'like', DB::raw("'yes'"))
                                    ->where('tbl_other_school_fees.coverage', 'like', DB::raw("'per new student'"));
                            })->orWhere(function ($query) {
                                $query->where('students_sub.transferee', 'like', DB::raw("'no'"))
