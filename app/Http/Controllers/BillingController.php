...
(
    ...
    public function fetchTempSummary(Request $request)
    {
        ...
        $data['hei_summary'] = $applicants->union($students)->selectRaw('students_sub.hei_name, COUNT(*) AS total_beneficiaries, sum(students_sub.total_fee) + sum(students_sub.exam_fees) as total_amount')->get();
