            ...
            foreach ($billings as $billing) {
                ...
                $output .= '</td>
                    <td>
                        ...
                        <button id="' . $billing->uid . '" name="btn_view_billing_test" class="btn_view_billing_test btn btn-outline-info btn-block btn-sm border rounded-pill" type="button"><i class="fas fa-eye"></i>View</button>
                    </td>
                </tr>';
            }
            $output .= ' </tbody>
