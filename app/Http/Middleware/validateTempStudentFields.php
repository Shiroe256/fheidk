...
class validateTempStudentFields
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $courses = array_column(OtherSchoolFees::selectRaw('UCASE(course_enrolled) AS course_enrolled_up')->where('hei_uii', $hei_uii)->groupBy('hei_uii', 'course_enrolled_up')->get()->toArray(), 'course_enrolled');
