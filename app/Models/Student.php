...
class Student extends Model
{
    ...
    protected $fillable = [
        ...
        'f_lname', 'sex', 'lrn', 'birthplace', 'birthdate', 'permanent_street', 'permanent_barangay',
        'permanent_city', 'permanent_province', 'permanent_zip', 'permanent_district', 'permanent_region',
        'present_street', 'present_barangay', 'present_city', 'present_province', 'present_zip',
        'present_district', 'present_region', 'pwd_no', 'contact_no', 'alt_contact_no', 'email',
        'alt_email', 'nationality', 'ay_graduated'
    ];
