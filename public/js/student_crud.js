...
function validateFields(data) {
  ...
  for (const stud of data) {
    ...
    if (stud['lab_u'] > 50 || stud['lab_u'] === undefined) error.push('Invalid Lab unit value. The Lab unit only accepts between 0 to 50.');
    if (stud['com_lab_u'] > 50 || stud['com_lab_u'] === undefined) error.push('Invalid Computer Lab unit value. The Computer Lab unit only accepts between 0 to 50.');
    if (stud['acad_u'] > 50 || stud['acad_u'] === undefined) error.push('Invalid Academic unit value. The academic unit only accepts between 0 to 50.');
    if (stud['nstp_u'] > 50 || stud['nstp_u'] === undefined) error.push('Invalid NSTP unit value. The NSTP unit only accepts between 0 to 50.');
