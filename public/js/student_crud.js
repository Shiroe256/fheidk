...
function validateFields(data) {
  ...
  for (const stud of data) {
    ...
    if (!emailpattern.test(stud['email']) || stud['email'] === undefined) error.push('The alternate email field isn\'t using a valid email format');
    if (!emailpattern.test(stud['a_email']) && stud['a_email'] != '') error.push('The alternate email field isn\'t using a valid email format');
